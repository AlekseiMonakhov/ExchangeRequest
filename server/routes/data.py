...
from models.data import Countries, Currencies, PaymentType, ErrorOutput, Banks, Cities, Purposes
from services.data import ContriesService, CurrenciesService, PaymentTypeService, CitiesService, BanksService, \
    PurposesService
...
@data_router.get('/currencies', response_model=List[Currencies], responses={400: {'model': ErrorOutput}})
